...
vis4.DelayedTask = function(delay, scope, func, args) {
	...
	me.func = arguments[2];
	me.scope = arguments[1];
	me.args = args;
	me.running = true;
	me.timer = window.setTimeout(this.run.bind(this), arguments[0]);
};

vis4.DelayedTask.prototype.run = function() {
	this.func.apply(this.scope, this.args);
	this.running = false;
};
vis4.DelayedTask.prototype.cancel = function() {
